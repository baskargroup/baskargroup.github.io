...
<div class="home-hero-wrap">
  ...
  <div class="home-hero-caption">
    <span class="eyebrow">Two-phase flow, Proteus solver</span>
    <p class="headline">Computational tools for food, energy, environment, and health</p>
  </div>
</div>
<script>
...
<style>
  /* Hero, eyebrow, and section rhythm come from the design system (_sass/_custom.scss). */
